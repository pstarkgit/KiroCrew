...
| [jev-shadow.md](jev-shadow.md) | Local-only Jev shadow seam: default-deny flag, redacted session-summary signal, bounded local receipt after summary generation, no provider call. |
