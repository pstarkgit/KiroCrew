...
export default function MembersPage() {
  ...
  // sibling — a past event is reported once, and reported individually.
  const schedErrSeq = useRef(0)
  const [schedErrors, setSchedErrors] = useState<Record<string, Array<{ id: number; message: string; confirmed: boolean }>>>({})
            ...
            <MemberScheduleDialog
              ...
              onSubmitError={(msg, confirmed) => {
                ...
                setSchedErrors((prev) => ({
                  ...
                  [schedFor]: [...(prev[schedFor] ?? []), { id: ++schedErrSeq.current, message: msg, confirmed }],
                }))
              }}
